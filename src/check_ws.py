...
class WSReader:
    ...
    def loop_categories(self):
        ...
        while obj:
            ...
            pdf.Print()
            hist_splusb = self.create_hist_from_pdf(pdf, "splusb_"+cat_name, obs_var)
            ...
            hist_bonly = self.create_hist_from_pdf(pdf, "bonly_"+cat_name, obs_var)
            ...
            hist_sonlypdf = ROOT.TH1F("sonlyPdf_"+cat_name, "data", obs_var.getBins(), obs_var.getMin(), obs_var.getMax())
...
if __name__ == "__main__":
    ...
    parser.add_option('-o', "--out_dir", dest='out_dir', help="name of output directory", default=".")
